...
int allocate_time(const Board* pos, int time) {
    ...
    // We obtain 11.5%, 72.4%, 16.1% for opening, middlegame, endgame respectively based on our thresholds
    // Of course, the exact numbers are quite arbitrary, but the main idea lies in the relative proportions
